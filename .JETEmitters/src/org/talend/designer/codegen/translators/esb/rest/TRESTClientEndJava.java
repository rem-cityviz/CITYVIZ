...
public class TRESTClientEndJava
{
  ...
  protected final String TEXT_3 = NL + NL + "if (globalMap.get(\"";
  protected final String TEXT_4 = "_NB_LINE\") == null) {" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_5 = "_NB_LINE\", 1);" + NL + "}" + NL + "" + NL + "// [tRESTCliend_end]";
