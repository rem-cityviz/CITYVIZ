...
public class TPostgresqlConnectionBeginJava
{
  ...
  protected final String TEXT_49 = "_ERROR_MESSAGE\",e_";
  protected final String TEXT_50 = ".getMessage());" + NL + "                    //do nothing" + NL + "            }" + NL + "        }" + NL + "    }";
  ...
  protected final String TEXT_135 = NL + NL + "\tglobalMap.put(\"schema_\" + \"";
