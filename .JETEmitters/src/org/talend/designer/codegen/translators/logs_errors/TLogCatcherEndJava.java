...
public class TLogCatcherEndJava
{
  ...
  protected final String TEXT_3 = "_ERROR_MESSAGE\",e_";
  protected final String TEXT_4 = ".getMessage());" + NL + "\tlogIgnoredError(String.format(\"";
  protected final String TEXT_5 = " - tLogCatcher failed to process log message(s) due to internal error: %s\", e_";
  protected final String TEXT_6 = "), e_";
