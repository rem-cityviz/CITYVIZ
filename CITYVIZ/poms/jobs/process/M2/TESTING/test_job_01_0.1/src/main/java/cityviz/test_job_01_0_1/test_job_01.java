...
package cityviz.test_job_01_0_1;
 ...
 * @status
 */
public class test_job_01 implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (citiviz_stg_main_table != null) {

				this.setProperty("citiviz_stg_main_table", citiviz_stg_main_table.toString());
		...
		public String citiviz_stg_main_table;

		public String getCitiviz_stg_main_table() {
			return this.citiviz_stg_main_table;
		}
	...
	private final String jobName = "test_job_01";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(test_job_01.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(context.cityviz_dwh_Password);
				System.out.println(context.cityviz_staging_Password);
	...
	public static void main(String[] args) {
		final test_job_01 test_job_01Class = new test_job_01();

		int exitCode = test_job_01Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test_job_01.class.getClassLoader()
					.getResourceAsStream("cityviz/test_job_01_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = test_job_01.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("citiviz_stg_main_table", "id_String");
					if (context.getStringValue("citiviz_stg_main_table") == null) {
						context.citiviz_stg_main_table = null;
					} else {
						context.citiviz_stg_main_table = (String) context.getProperty("citiviz_stg_main_table");
					}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("citiviz_stg_main_table")) {
				context.citiviz_stg_main_table = (String) parentContextMap.get("citiviz_stg_main_table");
			}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : test_job_01");
		}
...
/************************************************************************************************
 * 41668 characters generated by Talend Open Studio for Data Integration on the
 * 11 octobre 2022 à 11:33:34 CEST
 ************************************************************************************************/