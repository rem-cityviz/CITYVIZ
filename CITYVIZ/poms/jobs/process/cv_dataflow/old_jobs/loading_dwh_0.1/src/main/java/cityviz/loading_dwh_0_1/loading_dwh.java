...
package cityviz.loading_dwh_0_1;
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = loading_dwh.class.getClassLoader()
					.getResourceAsStream("cityviz/loading_dwh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 478037 characters generated by Talend Open Studio for Data Integration on the
 * 6 mars 2022 à 16:03:51 CET
 ************************************************************************************************/