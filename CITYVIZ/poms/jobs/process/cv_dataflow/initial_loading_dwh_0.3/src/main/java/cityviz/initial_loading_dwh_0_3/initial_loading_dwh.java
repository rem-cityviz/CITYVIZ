...
package cityviz.initial_loading_dwh_0_3;
...
/**
 * Job: initial_loading_dwh Purpose: Alimentation du dwh depuis notre base de
 * staging<br>
 * Description: 0.2 : Chargement des 3 tables dimensions ok, schémas ok et fixe
 * (voir les metadatas / modèles de données) 0.3 : Chargement table de fait OK
 * mais pas de log. Reste à faire le chargement de la table des dates. <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class initial_loading_dwh implements TalendJob {
	...
	private final String jobName = "initial_loading_dwh";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					initial_loading_dwh.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(initial_loading_dwh.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
				...
				try {
					...
					if (!whetherExist_tCreateTable_3) {
						...
						stmt_tCreateTable_3.execute("CREATE TABLE \"" + tableName_tCreateTable_3
								+ "\"(\"sirenetablissement\" VARCHAR ,\"siretetablissement\" VARCHAR ,\"siretetablissementvalide\" VARCHAR ,\"categorieetablissement\" VARCHAR ,\"denominationsocialeetablissement\" VARCHAR ,\"codecommuneetablissement\" VARCHAR ,\"communeetablissement\" VARCHAR ,\"departementetablissement\" VARCHAR ,\"libelledepartementetablissement\" VARCHAR ,\"coderegionetablissement\" VARCHAR ,\"libelleregionetablissement\" VARCHAR ,\"codenaf\" VARCHAR ,primary key(\"sirenetablissement\"))");
	...
	public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
		final static byte[] commonByteArrayLock_CITYVIZ_initial_loading_dwh = new byte[0];
		static byte[] commonByteArray_CITYVIZ_initial_loading_dwh = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CITYVIZ_initial_loading_dwh.length) {
					if (length < 1024 && commonByteArray_CITYVIZ_initial_loading_dwh.length == 0) {
						commonByteArray_CITYVIZ_initial_loading_dwh = new byte[1024];
					} else {
						commonByteArray_CITYVIZ_initial_loading_dwh = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CITYVIZ_initial_loading_dwh, 0, length);
				strReturn = new String(commonByteArray_CITYVIZ_initial_loading_dwh, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_CITYVIZ_initial_loading_dwh, 0, length);
				strReturn = new String(commonByteArray_CITYVIZ_initial_loading_dwh, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CITYVIZ_initial_loading_dwh) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						context.logs_path + "/initial_dwh_loading/doublons_dim_acheteur.csv")).getAbsolutePath()
								.replace("\\", "/");
...
// ###############################
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(
						context.logs_path + "/initial_dwh_loading/doublons_dim_marche.csv")).getAbsolutePath()
								.replace("\\", "/");
...
// ###############################
				...
				String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3
						+ "\" SET \"siretetablissement\" = ?,\"siretetablissementvalide\" = ?,\"categorieetablissement\" = ?,\"denominationsocialeetablissement\" = ?,\"codecommuneetablissement\" = ?,\"communeetablissement\" = ?,\"departementetablissement\" = ?,\"libelledepartementetablissement\" = ?,\"coderegionetablissement\" = ?,\"libelleregionetablissement\" = ?,\"codenaf\" = ? WHERE \"sirenetablissement\" = ?";
				...
				String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3
						+ "\" (\"sirenetablissement\",\"siretetablissement\",\"siretetablissementvalide\",\"categorieetablissement\",\"denominationsocialeetablissement\",\"codecommuneetablissement\",\"communeetablissement\",\"departementetablissement\",\"libelledepartementetablissement\",\"coderegionetablissement\",\"libelleregionetablissement\",\"codenaf\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				fileName_tFileOutputDelimited_3 = (new java.io.File(
						context.logs_path + "/initial_dwh_loading/doublons_dim_etablissement.csv")).getAbsolutePath()
								.replace("\\", "/");
				...
				fileName_tFileOutputDelimited_5 = (new java.io.File(
						context.logs_path + "/initial_dwh_loading/null_dim_etablissement.csv")).getAbsolutePath()
								.replace("\\", "/");
...
// ###############################
				...
				String dbquery_tDBInput_1 = "select * FROM stg.marche_v2";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row1.datepublicationdonnees = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 2);
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							row1.procedure = null;
						} else {

							row1.procedure = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row1.nature = null;
						} else {

							row1.nature = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						...
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							row1.datenotification = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 6);
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							row1.montant = null;
						} else {

							row1.montant = rs_tDBInput_1.getFloat(7);
						...
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							row1.siretetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							row1.objetmarche = null;
						} else {

							row1.objetmarche = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							row1.idacheteur = null;
						} else {

							row1.idacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
						}
						if (colQtyInRs_tDBInput_1 < 11) {
							row1.codecommuneacheteur = null;
						} else {

							row1.codecommuneacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
						}
						if (colQtyInRs_tDBInput_1 < 12) {
							row1.source = null;
						} else {

							row1.source = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
						}
						if (colQtyInRs_tDBInput_1 < 13) {
							row1.lieuexecutionnom = null;
						} else {

							row1.lieuexecutionnom = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
						}
						if (colQtyInRs_tDBInput_1 < 14) {
							row1.codearrondissementetablissement = null;
						} else {

							row1.codearrondissementetablissement = rs_tDBInput_1.getInt(14);
							if (rs_tDBInput_1.wasNull()) {
								row1.codearrondissementetablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 15) {
							...
							row1.libellearrondissementetablissement = rs_tDBInput_1.getInt(15);
							if (rs_tDBInput_1.wasNull()) {
								row1.libellearrondissementetablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 16) {
							...
							row1.sirenetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
						}
						if (colQtyInRs_tDBInput_1 < 17) {
							row1.codetypeetablissement = null;
						} else {

							row1.codetypeetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 17, false);
						}
						if (colQtyInRs_tDBInput_1 < 18) {
							row1.nicetablissement = null;
						} else {

							row1.nicetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 18, false);
						}
						if (colQtyInRs_tDBInput_1 < 19) {
							row1.lieuexecutiontypecode = null;
						} else {

							row1.lieuexecutiontypecode = routines.system.JDBCUtil.getString(rs_tDBInput_1, 19, false);
						}
						if (colQtyInRs_tDBInput_1 < 20) {
							row1.libelleregionetablissement = null;
						} else {

							row1.libelleregionetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20,
									false);
						}
						if (colQtyInRs_tDBInput_1 < 21) {
							...
							row1.categorieetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 21, false);
						}
						if (colQtyInRs_tDBInput_1 < 22) {
							row1.nomacheteur = null;
						} else {

							row1.nomacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 22, false);
						}
						if (colQtyInRs_tDBInput_1 < 23) {
							row1.idmarche = null;
						} else {

							row1.idmarche = rs_tDBInput_1.getInt(23);
							if (rs_tDBInput_1.wasNull()) {
								row1.idmarche = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 24) {
							...
							row1.communeetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, false);
						}
						if (colQtyInRs_tDBInput_1 < 25) {
							row1.libellecommuneacheteur = null;
						} else {

							row1.libellecommuneacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 25, false);
						}
						if (colQtyInRs_tDBInput_1 < 26) {
							row1.libelledepartementetablissement = null;
						} else {

							row1.libelledepartementetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 26,
									false);
						}
						if (colQtyInRs_tDBInput_1 < 27) {
							...
							row1.dureemoisestimee = routines.system.JDBCUtil.getString(rs_tDBInput_1, 27, false);
						}
						if (colQtyInRs_tDBInput_1 < 28) {
							row1.libelleregionacheteur = null;
						} else {

							row1.libelleregionacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 28, false);
						}
						if (colQtyInRs_tDBInput_1 < 29) {
							row1.coderegionacheteur = null;
						} else {

							row1.coderegionacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 29, false);
						}
						if (colQtyInRs_tDBInput_1 < 30) {
							row1.siretetablissementvalide = null;
						} else {

							row1.siretetablissementvalide = routines.system.JDBCUtil.getString(rs_tDBInput_1, 30,
									false);
						}
						if (colQtyInRs_tDBInput_1 < 31) {
							...
							row1.codecommuneetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 31,
									false);
						}
						if (colQtyInRs_tDBInput_1 < 32) {
							...
							row1.codepostalacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 32, false);
						}
						if (colQtyInRs_tDBInput_1 < 33) {
							row1.departementetablissement = null;
						} else {

							row1.departementetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 33,
									false);
						}
						if (colQtyInRs_tDBInput_1 < 34) {
							...
							row1.superficiecommuneacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 34,
									false);
						}
						if (colQtyInRs_tDBInput_1 < 35) {
							...
							row1.populationcommuneacheteur = rs_tDBInput_1.getFloat(35);
							if (rs_tDBInput_1.wasNull()) {
								row1.populationcommuneacheteur = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 36) {
							...
							row1.codedepartementexecution = rs_tDBInput_1.getFloat(36);
							if (rs_tDBInput_1.wasNull()) {
								row1.codedepartementexecution = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 37) {
							...
							row1.sirenacheteurvalide = routines.system.JDBCUtil.getString(rs_tDBInput_1, 37, false);
						}
						if (colQtyInRs_tDBInput_1 < 38) {
							row1.codearrondissementacheteur = null;
						} else {

							row1.codearrondissementacheteur = rs_tDBInput_1.getInt(38);
							if (rs_tDBInput_1.wasNull()) {
								row1.codearrondissementacheteur = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 39) {
							...
							row1.sirenetablissementvalide = routines.system.JDBCUtil.getString(rs_tDBInput_1, 39,
									false);
						}
						if (colQtyInRs_tDBInput_1 < 40) {
							...
							row1.dureemoiscalculee = rs_tDBInput_1.getFloat(40);
							if (rs_tDBInput_1.wasNull()) {
								row1.dureemoiscalculee = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 41) {
							...
							row1.populationcommuneetablissement = rs_tDBInput_1.getFloat(41);
							if (rs_tDBInput_1.wasNull()) {
								row1.populationcommuneetablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 42) {
							...
							row1.codecpv_division = rs_tDBInput_1.getInt(42);
							if (rs_tDBInput_1.wasNull()) {
								row1.codecpv_division = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 43) {
							...
							row1.denominationsocialeetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1,
									43, false);
						}
						if (colQtyInRs_tDBInput_1 < 44) {
							...
							row1.coderegionetablissement = rs_tDBInput_1.getInt(44);
							if (rs_tDBInput_1.wasNull()) {
								row1.coderegionetablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 45) {
							...
							row1.lieuexecutioncode = routines.system.JDBCUtil.getString(rs_tDBInput_1, 45, false);
						}
						if (colQtyInRs_tDBInput_1 < 46) {
							row1.moisnotification = null;
						} else {

							row1.moisnotification = routines.system.JDBCUtil.getString(rs_tDBInput_1, 46, false);
						}
						if (colQtyInRs_tDBInput_1 < 47) {
							row1.codecpv_original = null;
						} else {

							row1.codecpv_original = routines.system.JDBCUtil.getString(rs_tDBInput_1, 47, false);
						}
						if (colQtyInRs_tDBInput_1 < 48) {
							row1.typeidentifiantetablissement = null;
						} else {

							row1.typeidentifiantetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 48,
									false);
						}
						if (colQtyInRs_tDBInput_1 < 49) {
							...
							row1.dureemois = rs_tDBInput_1.getInt(49);
							if (rs_tDBInput_1.wasNull()) {
								row1.dureemois = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 50) {
							...
							row1.libellearrondissementacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 50,
									false);
						}
						if (colQtyInRs_tDBInput_1 < 51) {
							...
							row1.nombretitulairesurmarchepresume = rs_tDBInput_1.getFloat(51);
							if (rs_tDBInput_1.wasNull()) {
								row1.nombretitulairesurmarchepresume = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 52) {
							...
							row1.adresseetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 52, false);
						}
						if (colQtyInRs_tDBInput_1 < 53) {
							row1.superficiecommuneetablissement = null;
						} else {

							row1.superficiecommuneetablissement = rs_tDBInput_1.getFloat(53);
							if (rs_tDBInput_1.wasNull()) {
								row1.superficiecommuneetablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 54) {
							...
							row1.distanceacheteuretablissement = rs_tDBInput_1.getFloat(54);
							if (rs_tDBInput_1.wasNull()) {
								row1.distanceacheteuretablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 55) {
							...
							row1.natureobjetmarche = routines.system.JDBCUtil.getString(rs_tDBInput_1, 55, false);
						}
						if (colQtyInRs_tDBInput_1 < 56) {
							row1.formeprix = null;
						} else {

							row1.formeprix = routines.system.JDBCUtil.getString(rs_tDBInput_1, 56, false);
						}
						if (colQtyInRs_tDBInput_1 < 57) {
							row1.anneenotification = null;
						} else {

							row1.anneenotification = routines.system.JDBCUtil.getString(rs_tDBInput_1, 57, false);
						}
						if (colQtyInRs_tDBInput_1 < 58) {
							row1.libelledepartementacheteur = null;
						} else {

							row1.libelledepartementacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 58,
									false);
						}
						if (colQtyInRs_tDBInput_1 < 59) {
							...
							row1.departementacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 59, false);
						}
						if (colQtyInRs_tDBInput_1 < 60) {
							row1.codepostaletablissement = null;
						} else {

							row1.codepostaletablissement = routines.system.JDBCUtil.getString(rs_tDBInput_1, 60, false);
						}
						if (colQtyInRs_tDBInput_1 < 61) {
							row1.montantcalcule = null;
						} else {

							row1.montantcalcule = rs_tDBInput_1.getFloat(61);
							if (rs_tDBInput_1.wasNull()) {
								row1.montantcalcule = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 62) {
							...
							row1.coderegionexecution = rs_tDBInput_1.getFloat(62);
							if (rs_tDBInput_1.wasNull()) {
								row1.coderegionexecution = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 63) {
							...
							row1.codecpv = routines.system.JDBCUtil.getString(rs_tDBInput_1, 63, false);
						}
						if (colQtyInRs_tDBInput_1 < 64) {
							row1.referencecpv = null;
						} else {

							row1.referencecpv = routines.system.JDBCUtil.getString(rs_tDBInput_1, 64, false);
						}
						if (colQtyInRs_tDBInput_1 < 65) {
							row1.libelleregionexecution = null;
						} else {

							row1.libelleregionexecution = routines.system.JDBCUtil.getString(rs_tDBInput_1, 65, false);
						}
...
// # Output table : 'dim_etablissement'
							...
							dim_etablissement_tmp.codenaf = row1.codetypeetablissement;
...
// Start of branch "dim_acheteur"
						if (dim_acheteur != null) {
							...
							{ // start of Var scope
								...
								Var.isNull = DataProcessing.checkForNull(dim_acheteur.idacheteur);// ###############################
								// ###############################
								// # Output tables
							...
							if (marche != null) {
								...
								if (marche.datenotification != null) {
									pstmtUpdate_tDBOutput_2.setTimestamp(3,
											new java.sql.Timestamp(marche.datenotification.getTime()));
								} else {
							...
							if (doublon_marche != null) {
								...
								if (doublon_marche.datenotification != null) {
									sb_tFileOutputDelimited_2.append(
											FormatterUtils.format_Date(doublon_marche.datenotification, "yyyy-MM-dd"));
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
...
// # Filter conditions 
								...
								Var.isNotNull
									...
									etablissement_tmp.codenaf = dim_etablissement.codenaf;
...
// Start of branch "etablissement"
							if (etablissement != null) {
								...
								if (etablissement.coderegionetablissement == null) {
									...
									pstmtUpdate_tDBOutput_3.setInt(9, etablissement.coderegionetablissement);
								}
								...
								try {
									...
									if (updateFlag_tDBOutput_3 == 0) {
										...
										if (etablissement.coderegionetablissement == null) {
											...
											pstmtInsert_tDBOutput_3.setInt(10, etablissement.coderegionetablissement);
										}
										...
										if (etablissement.codenaf == null) {
											...
											pstmtInsert_tDBOutput_3.setString(12, etablissement.codenaf);
										}
								...
								if (!whetherReject_tDBOutput_3) {
									...
									row6.codenaf = etablissement.codenaf;
								}
...
// ###############################      
	...
	public static class row9Struct implements routines.system.IPersistableRow<row9Struct> {
		...
		public Float montantmarche;

		public Float getMontantmarche() {
			...
			synchronized (commonByteArrayLock_CITYVIZ_initial_loading_dwh) {
				...
				try {
					...
					if (length == -1) {
						...
						this.montantmarche = dis.readFloat();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.montantmarche == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeFloat(this.montantmarche);
				}
		...
		public String toString() {
			...
			sb.append(",datenotification=" + String.valueOf(datenotification));
			sb.append(",idmarche=" + String.valueOf(idmarche));
			sb.append(",montantmarche=" + String.valueOf(montantmarche));
...
// ###############################
				...
				String dbquery_tDBInput_5 = "select * FROM stg.marche_v2";
				...
				try {
					...
					while (rs_tDBInput_5.next()) {
						...
						if (colQtyInRs_tDBInput_5 < 2) {
							...
							row8.datepublicationdonnees = routines.system.JDBCUtil.getDate(rs_tDBInput_5, 2);
						}
						if (colQtyInRs_tDBInput_5 < 3) {
							row8.procedure = null;
						} else {

							row8.procedure = routines.system.JDBCUtil.getString(rs_tDBInput_5, 3, false);
						}
						if (colQtyInRs_tDBInput_5 < 4) {
							row8.nature = null;
						} else {

							row8.nature = routines.system.JDBCUtil.getString(rs_tDBInput_5, 4, false);
						}
						if (colQtyInRs_tDBInput_5 < 5) {
							row8.type = null;
						} else {

							row8.type = routines.system.JDBCUtil.getString(rs_tDBInput_5, 5, false);
						}
						if (colQtyInRs_tDBInput_5 < 6) {
							row8.datenotification = null;
						} else {

							row8.datenotification = routines.system.JDBCUtil.getDate(rs_tDBInput_5, 6);
						}
						if (colQtyInRs_tDBInput_5 < 7) {
							row8.montant = null;
						} else {

							row8.montant = rs_tDBInput_5.getFloat(7);
						...
						if (colQtyInRs_tDBInput_5 < 8) {
							...
							row8.siretetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 8, false);
						}
						if (colQtyInRs_tDBInput_5 < 9) {
							row8.objetmarche = null;
						} else {

							row8.objetmarche = routines.system.JDBCUtil.getString(rs_tDBInput_5, 9, false);
						}
						if (colQtyInRs_tDBInput_5 < 10) {
							row8.idacheteur = null;
						} else {

							row8.idacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 10, false);
						}
						if (colQtyInRs_tDBInput_5 < 11) {
							row8.codecommuneacheteur = null;
						} else {

							row8.codecommuneacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 11, false);
						}
						if (colQtyInRs_tDBInput_5 < 12) {
							row8.source = null;
						} else {

							row8.source = routines.system.JDBCUtil.getString(rs_tDBInput_5, 12, false);
						}
						if (colQtyInRs_tDBInput_5 < 13) {
							row8.lieuexecutionnom = null;
						} else {

							row8.lieuexecutionnom = routines.system.JDBCUtil.getString(rs_tDBInput_5, 13, false);
						}
						if (colQtyInRs_tDBInput_5 < 14) {
							row8.codearrondissementetablissement = null;
						} else {

							row8.codearrondissementetablissement = rs_tDBInput_5.getInt(14);
							if (rs_tDBInput_5.wasNull()) {
								row8.codearrondissementetablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 15) {
							...
							row8.libellearrondissementetablissement = rs_tDBInput_5.getInt(15);
							if (rs_tDBInput_5.wasNull()) {
								row8.libellearrondissementetablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 16) {
							...
							row8.sirenetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 16, false);
						}
						if (colQtyInRs_tDBInput_5 < 17) {
							row8.codetypeetablissement = null;
						} else {

							row8.codetypeetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 17, false);
						}
						if (colQtyInRs_tDBInput_5 < 18) {
							row8.nicetablissement = null;
						} else {

							row8.nicetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 18, false);
						}
						if (colQtyInRs_tDBInput_5 < 19) {
							row8.lieuexecutiontypecode = null;
						} else {

							row8.lieuexecutiontypecode = routines.system.JDBCUtil.getString(rs_tDBInput_5, 19, false);
						}
						if (colQtyInRs_tDBInput_5 < 20) {
							row8.libelleregionetablissement = null;
						} else {

							row8.libelleregionetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 20,
									false);
						}
						if (colQtyInRs_tDBInput_5 < 21) {
							...
							row8.categorieetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 21, false);
						}
						if (colQtyInRs_tDBInput_5 < 22) {
							row8.nomacheteur = null;
						} else {

							row8.nomacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 22, false);
						}
						if (colQtyInRs_tDBInput_5 < 23) {
							row8.idmarche = null;
						} else {

							row8.idmarche = rs_tDBInput_5.getInt(23);
							if (rs_tDBInput_5.wasNull()) {
								row8.idmarche = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 24) {
							...
							row8.communeetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 24, false);
						}
						if (colQtyInRs_tDBInput_5 < 25) {
							row8.libellecommuneacheteur = null;
						} else {

							row8.libellecommuneacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 25, false);
						}
						if (colQtyInRs_tDBInput_5 < 26) {
							row8.libelledepartementetablissement = null;
						} else {

							row8.libelledepartementetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 26,
									false);
						}
						if (colQtyInRs_tDBInput_5 < 27) {
							...
							row8.dureemoisestimee = routines.system.JDBCUtil.getString(rs_tDBInput_5, 27, false);
						}
						if (colQtyInRs_tDBInput_5 < 28) {
							row8.libelleregionacheteur = null;
						} else {

							row8.libelleregionacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 28, false);
						}
						if (colQtyInRs_tDBInput_5 < 29) {
							row8.coderegionacheteur = null;
						} else {

							row8.coderegionacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 29, false);
						}
						if (colQtyInRs_tDBInput_5 < 30) {
							row8.siretetablissementvalide = null;
						} else {

							row8.siretetablissementvalide = routines.system.JDBCUtil.getString(rs_tDBInput_5, 30,
									false);
						}
						if (colQtyInRs_tDBInput_5 < 31) {
							...
							row8.codecommuneetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 31,
									false);
						}
						if (colQtyInRs_tDBInput_5 < 32) {
							...
							row8.codepostalacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 32, false);
						}
						if (colQtyInRs_tDBInput_5 < 33) {
							row8.departementetablissement = null;
						} else {

							row8.departementetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 33,
									false);
						}
						if (colQtyInRs_tDBInput_5 < 34) {
							...
							row8.superficiecommuneacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 34,
									false);
						}
						if (colQtyInRs_tDBInput_5 < 35) {
							...
							row8.populationcommuneacheteur = rs_tDBInput_5.getFloat(35);
							if (rs_tDBInput_5.wasNull()) {
								row8.populationcommuneacheteur = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 36) {
							...
							row8.codedepartementexecution = rs_tDBInput_5.getFloat(36);
							if (rs_tDBInput_5.wasNull()) {
								row8.codedepartementexecution = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 37) {
							...
							row8.sirenacheteurvalide = routines.system.JDBCUtil.getString(rs_tDBInput_5, 37, false);
						}
						if (colQtyInRs_tDBInput_5 < 38) {
							row8.codearrondissementacheteur = null;
						} else {

							row8.codearrondissementacheteur = rs_tDBInput_5.getInt(38);
							if (rs_tDBInput_5.wasNull()) {
								row8.codearrondissementacheteur = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 39) {
							...
							row8.sirenetablissementvalide = routines.system.JDBCUtil.getString(rs_tDBInput_5, 39,
									false);
						}
						if (colQtyInRs_tDBInput_5 < 40) {
							...
							row8.dureemoiscalculee = rs_tDBInput_5.getFloat(40);
							if (rs_tDBInput_5.wasNull()) {
								row8.dureemoiscalculee = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 41) {
							...
							row8.populationcommuneetablissement = rs_tDBInput_5.getFloat(41);
							if (rs_tDBInput_5.wasNull()) {
								row8.populationcommuneetablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 42) {
							...
							row8.codecpv_division = rs_tDBInput_5.getInt(42);
							if (rs_tDBInput_5.wasNull()) {
								row8.codecpv_division = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 43) {
							...
							row8.denominationsocialeetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5,
									43, false);
						}
						if (colQtyInRs_tDBInput_5 < 44) {
							...
							row8.coderegionetablissement = rs_tDBInput_5.getInt(44);
							if (rs_tDBInput_5.wasNull()) {
								row8.coderegionetablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 45) {
							...
							row8.lieuexecutioncode = routines.system.JDBCUtil.getString(rs_tDBInput_5, 45, false);
						}
						if (colQtyInRs_tDBInput_5 < 46) {
							row8.moisnotification = null;
						} else {

							row8.moisnotification = routines.system.JDBCUtil.getString(rs_tDBInput_5, 46, false);
						}
						if (colQtyInRs_tDBInput_5 < 47) {
							row8.codecpv_original = null;
						} else {

							row8.codecpv_original = routines.system.JDBCUtil.getString(rs_tDBInput_5, 47, false);
						}
						if (colQtyInRs_tDBInput_5 < 48) {
							row8.typeidentifiantetablissement = null;
						} else {

							row8.typeidentifiantetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 48,
									false);
						}
						if (colQtyInRs_tDBInput_5 < 49) {
							...
							row8.dureemois = rs_tDBInput_5.getInt(49);
							if (rs_tDBInput_5.wasNull()) {
								row8.dureemois = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 50) {
							...
							row8.libellearrondissementacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 50,
									false);
						}
						if (colQtyInRs_tDBInput_5 < 51) {
							...
							row8.nombretitulairesurmarchepresume = rs_tDBInput_5.getFloat(51);
							if (rs_tDBInput_5.wasNull()) {
								row8.nombretitulairesurmarchepresume = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 52) {
							...
							row8.adresseetablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 52, false);
						}
						if (colQtyInRs_tDBInput_5 < 53) {
							row8.superficiecommuneetablissement = null;
						} else {

							row8.superficiecommuneetablissement = rs_tDBInput_5.getFloat(53);
							if (rs_tDBInput_5.wasNull()) {
								row8.superficiecommuneetablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 54) {
							...
							row8.distanceacheteuretablissement = rs_tDBInput_5.getFloat(54);
							if (rs_tDBInput_5.wasNull()) {
								row8.distanceacheteuretablissement = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 55) {
							...
							row8.natureobjetmarche = routines.system.JDBCUtil.getString(rs_tDBInput_5, 55, false);
						}
						if (colQtyInRs_tDBInput_5 < 56) {
							row8.formeprix = null;
						} else {

							row8.formeprix = routines.system.JDBCUtil.getString(rs_tDBInput_5, 56, false);
						}
						if (colQtyInRs_tDBInput_5 < 57) {
							row8.anneenotification = null;
						} else {

							row8.anneenotification = routines.system.JDBCUtil.getString(rs_tDBInput_5, 57, false);
						}
						if (colQtyInRs_tDBInput_5 < 58) {
							row8.libelledepartementacheteur = null;
						} else {

							row8.libelledepartementacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 58,
									false);
						}
						if (colQtyInRs_tDBInput_5 < 59) {
							...
							row8.departementacheteur = routines.system.JDBCUtil.getString(rs_tDBInput_5, 59, false);
						}
						if (colQtyInRs_tDBInput_5 < 60) {
							row8.codepostaletablissement = null;
						} else {

							row8.codepostaletablissement = routines.system.JDBCUtil.getString(rs_tDBInput_5, 60, false);
						}
						if (colQtyInRs_tDBInput_5 < 61) {
							row8.montantcalcule = null;
						} else {

							row8.montantcalcule = rs_tDBInput_5.getFloat(61);
							if (rs_tDBInput_5.wasNull()) {
								row8.montantcalcule = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 62) {
							...
							row8.coderegionexecution = rs_tDBInput_5.getFloat(62);
							if (rs_tDBInput_5.wasNull()) {
								row8.coderegionexecution = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 63) {
							...
							row8.codecpv = routines.system.JDBCUtil.getString(rs_tDBInput_5, 63, false);
						}
						if (colQtyInRs_tDBInput_5 < 64) {
							row8.referencecpv = null;
						} else {

							row8.referencecpv = routines.system.JDBCUtil.getString(rs_tDBInput_5, 64, false);
						}
						if (colQtyInRs_tDBInput_5 < 65) {
							row8.libelleregionexecution = null;
						} else {

							row8.libelleregionexecution = routines.system.JDBCUtil.getString(rs_tDBInput_5, 65, false);
						}
						...
						{ // start of Var scope
							...
							Var.newDate = DataProcessing.replaceNullDate(row8.datenotification);
							Var.newIdacheteur = DataProcessing.replaceNullString(row8.idacheteur);// ###############################
							// ###############################
							// # Output tables
...
// # Output table : 'fait_marche'
							...
							fait_marche_tmp.idacheteur = Var.newIdacheteur;
...
// Start of branch "fait_marche"
						if (fait_marche != null) {
							...
							if (fait_marche.montantmarche == null) {
								pstmtUpdate_tDBOutput_4.setNull(1, java.sql.Types.FLOAT);
							} else {
								pstmtUpdate_tDBOutput_4.setFloat(1, fait_marche.montantmarche);
							}
							...
							if (fait_marche.datenotification != null) {
								pstmtUpdate_tDBOutput_4.setTimestamp(5 + count_tDBOutput_4,
										new java.sql.Timestamp(fait_marche.datenotification.getTime()));
							} else {
							...
							try {
								...
								if (updateFlag_tDBOutput_4 == 0) {
									...
									if (fait_marche.datenotification != null) {
										pstmtInsert_tDBOutput_4.setTimestamp(3,
												new java.sql.Timestamp(fait_marche.datenotification.getTime()));
									} else {
									...
									if (fait_marche.montantmarche == null) {
										pstmtInsert_tDBOutput_4.setNull(5, java.sql.Types.FLOAT);
									} else {
										pstmtInsert_tDBOutput_4.setFloat(5, fait_marche.montantmarche);
									}
...
// ###############################      
	...
	public static void main(String[] args) {
		final initial_loading_dwh initial_loading_dwhClass = new initial_loading_dwh();

		int exitCode = initial_loading_dwhClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = initial_loading_dwh.class.getClassLoader()
					.getResourceAsStream("cityviz/initial_loading_dwh_0_3/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = initial_loading_dwh.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : initial_loading_dwh");
		}
...
/************************************************************************************************
 * 622040 characters generated by Talend Open Studio for Data Integration on the
 * 30 mars 2022 à 15:01:31 CEST
 ************************************************************************************************/